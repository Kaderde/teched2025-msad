...
# Exercise 3.1 - Audit logging in CAP
Vulnerability: Unauthorized Access to Credit Card Data via IDOR

## 📖  1. Overview :

Security Logging and Monitoring Failures occur when an application does not properly log access to sensitive data or critical operations, preventing detection of unauthorized access or malicious activity. In our Incident Management system, we will demonstrate how a support user can exploit Logging to access credit card numbers stored in the Customers entity.
